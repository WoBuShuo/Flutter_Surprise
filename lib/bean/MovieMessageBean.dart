...
class MovieMessageBean {
    Basic basic;
    BoxOffice boxOffice;
    String playState;
    List<Playlist> playlist;

    MovieMessageBean({this.basic, this.boxOffice, this.playState, this.playlist});

    factory MovieMessageBean.fromJson(Map<String, dynamic> json) {
        return MovieMessageBean(
